        ...
        "SpacePortal.useEffect": ()=>{
            if (isActive) {
                const newParticles = Array.from({
                    ...
                    "SpacePortal.useEffect.newParticles": (_, i)=>({
                            id: i,
                            x: Math.random() * 100,
                            y: Math.random() * 100,
                ...
                }["SpacePortal.useEffect.newParticles"]);
                setParticles(newParticles);
                // Вызываем callback после завершения анимации
                const timer = setTimeout({
                    "SpacePortal.useEffect.timer": ()=>{
                        if (onComplete) onComplete();
                    }
                }["SpacePortal.useEffect.timer"], 2000);
                return ({
                    "SpacePortal.useEffect": ()=>clearTimeout(timer)
                })["SpacePortal.useEffect"];
            }
        }
    }["SpacePortal.useEffect"], [
...
_s(SpacePortal, "n2oV9J0JxRF0n1eg4nXLNJcP/RY=");
_c = SpacePortal;
var _c;
...
//# sourceMappingURL=src_88fce3f9._.js.map