...
"[project]/src/app/theme-init-script.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
_c = ThemeInitScript;
var _c;
__turbopack_context__.k.register(_c, "ThemeInitScript");
...
"[project]/src/app/theme-styles.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ThemeScript.useEffect": ()=>{
            ...
            const applyDarkModeStyles = {
                "ThemeScript.useEffect.applyDarkModeStyles": ()=>{
        ...
        `;
                        ...
                        const applyStyles = {
                            "ThemeScript.useEffect.applyDarkModeStyles.applyStyles": ()=>{
                                // Обрабатываем хедеры и карточки
                                document.querySelectorAll('header, [role="dialog"], .card, [class*="Card"]').forEach({
                                    "ThemeScript.useEffect.applyDarkModeStyles.applyStyles": (el)=>{
                                ...
                                document.querySelectorAll('.DialogContent, [class*="DialogContent"]').forEach({
                                    "ThemeScript.useEffect.applyDarkModeStyles.applyStyles": (el)=>{
                                        if (el instanceof HTMLElement) {
                                            el.style.backgroundColor = darkBlueTheme.cardBg;
                                            el.style.borderColor = darkBlueTheme.border;
                                ...
                                document.querySelectorAll('[class*="bg-gray"], .bg-gray-50, .bg-gray-100, .bg-gray-200, .bg-gray-300, .bg-gray-400, .bg-gray-500, .bg-gray-600, .bg-gray-700, .bg-gray-800, .bg-gray-900').forEach({
                                    "ThemeScript.useEffect.applyDarkModeStyles.applyStyles": (el)=>{
                                        if (el instanceof HTMLElement) {
                                ...
                                document.querySelectorAll("tr").forEach({
                                    "ThemeScript.useEffect.applyDarkModeStyles.applyStyles": (row)=>{
                                        ...
                                        row.addEventListener("mouseenter", {
                                            "ThemeScript.useEffect.applyDarkModeStyles.applyStyles": function() {
                                ...
                                document.querySelectorAll("div[style*='background-image'], div[style*='gradient']").forEach({
                                    "ThemeScript.useEffect.applyDarkModeStyles.applyStyles": (el)=>{
                                        if (el instanceof HTMLElement) {
                        ...
                        document.querySelectorAll('[style*="background-color"], [style*="border-color"], .custom-hover-active').forEach({
                            "ThemeScript.useEffect.applyDarkModeStyles": (el)=>{
                                if (el instanceof HTMLElement) {
                        ...
                        document.querySelectorAll("tr").forEach({
                            "ThemeScript.useEffect.applyDarkModeStyles": (row)=>{
                                const oldMouseEnter = row.onmouseenter;
                                const oldMouseLeave = row.onmouseleave;
                                if (oldMouseEnter) row.removeEventListener("mouseenter", oldMouseEnter);
                                if (oldMouseLeave) row.removeEventListener("mouseleave", oldMouseLeave);
            ...
            const themeObserver = new MutationObserver({
                "ThemeScript.useEffect": (mutations)=>{
                    mutations.forEach({
                        "ThemeScript.useEffect": (mutation)=>{
...
//# sourceMappingURL=src_8dd0b0c4._.js.map