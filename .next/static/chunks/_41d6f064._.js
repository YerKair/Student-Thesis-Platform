...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/teams/api/teams-service.ts [app-client] (ecmascript)");
...
function useTeams() {
    ...
    const fetchTeams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[fetchTeams]": async ()=>{
            if (!token) return;
            try {
                setState({
                    "useTeams.useCallback[fetchTeams]": (prev)=>({
                            ...prev,
                            isLoading: true
                        })
                }["useTeams.useCallback[fetchTeams]"]);
                const teams = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getTeams(token);
                setState({
                    "useTeams.useCallback[fetchTeams]": (prev)=>({
                            ...prev,
                            teams,
    ...
    const fetchMyTeams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[fetchMyTeams]": async ()=>{
            ...
            try {
                ...
                const teams = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getMyTeams(token);
                setState({
                    "useTeams.useCallback[fetchMyTeams]": (prev)=>({
                            ...prev,
                            myTeams: teams,
    ...
    const fetchAvailableTeams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[fetchAvailableTeams]": async ()=>{
            if (!token) return;
            try {
                setState({
                    "useTeams.useCallback[fetchAvailableTeams]": (prev)=>({
                            ...prev,
                            isLoading: true
                        })
                }["useTeams.useCallback[fetchAvailableTeams]"]);
                const teams = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getAvailableTeams(token);
                setState({
                    "useTeams.useCallback[fetchAvailableTeams]": (prev)=>({
                            ...prev,
    ...
    const createTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[createTeam]": async (name)=>{
            ...
            try {
                ...
                const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].createTeam({
                    name,
                    code
                }, token);
                setState({
    ...
    const joinTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[joinTeam]": async (code)=>{
            ...
            try {
                ...
                const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].joinTeam({
                    team_code: code
                }, token);
                setState({
                    "useTeams.useCallback[joinTeam]": (prev)=>({
    ...
    const getTeamMembers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[getTeamMembers]": async (teamId)=>{
            if (!token) return;
            try {
                return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getTeamMembers(teamId, token);
            } catch (error) {
    ...
    const deleteTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[deleteTeam]": async (teamId)=>{
            ...
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].deleteTeam(teamId, token);
                setState({
                    "useTeams.useCallback[deleteTeam]": (prev)=>({
                            ...prev,
                            teams: prev.teams.filter({
                                "useTeams.useCallback[deleteTeam]": (t)=>t.id !== teamId
                            }["useTeams.useCallback[deleteTeam]"]),
                            isLoading: false
                        })
                }["useTeams.useCallback[deleteTeam]"]);
    ...
    const assignSupervisor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[assignSupervisor]": async (teamId)=>{
            if (!token) return;
            try {
                setState({
                    "useTeams.useCallback[assignSupervisor]": (prev)=>({
                            ...prev,
                            isLoading: true
                        })
                }["useTeams.useCallback[assignSupervisor]"]);
                const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].assignSupervisor(teamId, token);
                setState({
                    "useTeams.useCallback[assignSupervisor]": (prev)=>({
                            ...prev,
                            teams: prev.teams.map({
                                "useTeams.useCallback[assignSupervisor]": (t)=>t.id === teamId ? team : t
                            }["useTeams.useCallback[assignSupervisor]"]),
                            isLoading: false
                        })
                }["useTeams.useCallback[assignSupervisor]"]);
...
_s(useTeams, "pHJRiwibx7wR89hW3rDojwQGsv0=", false, function() {
    return [
...
function TeamsPage() {
    ...
    const { myTeams: teams, isLoading, createTeam, joinTeam, getTeamMembers, deleteTeam, fetchMyTeams } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$lib$2f$use$2d$teams$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeams"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamsPage.useEffect": ()=>{
            ...
            const isStudent = user.roles && user.roles.includes("student") || user.role === "student";
            if (!isStudent) {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-x-4",
                        children: !teams.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                            ...
                            selectedTeam === team.id && teamMembers[team.id] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "space-y-2",
                                        children: teamMembers[team.id].map((member)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                    children: "Вы уверены, что хотите удалить эту команду? Это действие нельзя отменить."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/teams/page.tsx",
                                    lineNumber: 314,
                                    columnNumber: 13
...
_s(TeamsPage, "Lj1vFE+/W7QLvM4yTdUpn3MvvaQ=", false, function() {
    return [
...
//# sourceMappingURL=_41d6f064._.js.map