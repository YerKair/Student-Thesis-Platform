...
"[project]/src/features/users/api/users-service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class UsersService {
    ...
    static async getUserByEmail(email, token) {
        try {
            const response = await fetch(`${API_BASE_URL}/users/get-user-by-email?email=${email}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    static async updateRoles(userId, roles, token) {
        try {
    ...
    static async addRole(userId, role, token) {
        try {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/users/api/users-service.ts [app-client] (ecmascript)");
...
function UsersPage() {
    ...
    const fetchUsers = async ()=>{
        if (!token) return;
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UsersService"].getUsers(token);
            setUsers(response);
        } catch (error) {
            console.error("Failed to fetch users:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Не удалось загрузить список пользователей");
        } finally{
            setLoading(false);
        }
    };
        ...
        try {
            ...
            if (currentRoles.includes(role)) {
                ...
                if (currentRoles.length === 1) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("У пользователя должна быть хотя бы одна роль");
                    return;
                }
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UsersService"].updateRoles(userId, newRoles, token);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Роли пользователя успешно обновлены");
            await fetchUsers(); // Обновляем список
        } catch (error) {
            console.error("Failed to update user roles:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Не удалось обновить роли пользователя");
        }
    };
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: AVAILABLE_ROLES.map((role)=>{
                                                ...
                                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    size: "sm",
                                                    onClick: ()=>handleRoleToggle(user.id, role.value),
                                                    className: "flex items-center gap-1",
                                                    children: [
                                                        hasRole ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
                                                            className: "w-4 h-4"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/admin/users/page.tsx",
                                                            lineNumber: 121,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                        children: user.isActive === undefined ? "Неизвестно" : user.isActive ? "Активный" : "Неактивный"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/users/page.tsx",
                                        lineNumber: 131,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                        children: user.createdAt ? new Date(user.createdAt).toLocaleDateString("ru-RU") : "Неизвестно"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/users/page.tsx",
                                        lineNumber: 138,
                                        columnNumber: 15
...
_s(UsersPage, "NxDmHBQYi5PvUCVNM8hUXa6X1a4=", false, function() {
    return [
...
//# sourceMappingURL=_a277cdcc._.js.map