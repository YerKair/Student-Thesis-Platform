...
"[project]/src/features/auth/lib/user-service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class UserService {
    ...
    static async addRole(userId, role, token) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/users/${userId}/roles`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
    ...
    static async getUsers(token) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/users`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$lib$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/auth/lib/user-service.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AdminRegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$lib$2f$user$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserService"].registerAdmin(formData);
            toast({
                title: "Success",
            ...
            toast({
                variant: "destructive",
                title: "Error",
                description: error instanceof Error ? error.message : "Failed to register admin"
            });
        } finally{
            setIsLoading(false);
        }
...
_s(AdminRegisterPage, "XoJdLDvb+XkTkhASStzK5W1un8Y=", false, function() {
    return [
...
//# sourceMappingURL=src_6fed0bc3._.js.map