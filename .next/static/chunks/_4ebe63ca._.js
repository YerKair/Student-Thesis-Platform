...
function TeamsPage() {
    ...
    const { isLoading, teams, createTeam, joinTeam, fetchTeams, getTeamMembers, deleteTeam } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$lib$2f$use$2d$teams$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeams"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamsPage.useEffect": ()=>{
            ...
            const isStudent = user.roles.some({
                "TeamsPage.useEffect.isStudent": (role)=>role.toLowerCase() === "student"
            }["TeamsPage.useEffect.isStudent"]);
            if (!isStudent) {
                toast({
    ...
    const myTeams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TeamsPage.useMemo[myTeams]": ()=>{
            if (!user?.id || !teams) return [];
            return teams.filter({
                "TeamsPage.useMemo[myTeams]": (team)=>team.members.some({
                        "TeamsPage.useMemo[myTeams]": (member)=>Number(member.id) === Number(user.id)
                    }["TeamsPage.useMemo[myTeams]"])
            }["TeamsPage.useMemo[myTeams]"]);
        }
    }["TeamsPage.useMemo[myTeams]"], [
...
_s(TeamsPage, "BBGuDSAqD2FKXhQ6VkuSUW6HoTY=", false, function() {
    return [
...
//# sourceMappingURL=_4ebe63ca._.js.map