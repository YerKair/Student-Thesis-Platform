...
function UsersPage() {
    _s();
    const { token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$auth$2f$lib$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const fetchUsers = async ()=>{
        try {
            if (!token) return;
            const fetchedUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UsersService"].getUsers(token);
...
_s(UsersPage, "CXFV+rShX+90UwjRrHujAHBdl6U=", false, function() {
    return [
...
//# sourceMappingURL=src_705265a5._.js.map