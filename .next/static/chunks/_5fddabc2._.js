...
"[project]/src/features/logger/api/logger.service.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
class LoggerService {
    static async logAction(token, data) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/logs/create`, {
                method: "POST",
                headers: {
    ...
    static async getLogsByEntityId(token, entityId) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/logs/entity/${entityId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    static async getUserLogs(token, userId) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/logs/user/${userId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/config/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$logger$2f$api$2f$logger$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/logger/api/logger.service.ts [app-client] (ecmascript)");
;
;
class TeamsService {
    static async createTeam(token, data) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
            ...
            // Log team creation
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$logger$2f$api$2f$logger$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoggerService"].logAction(token, {
                action: "create_team",
                details: `Created team: ${teamWithMembers.name}`,
                userId: teamWithMembers.creator_id.toString(),
                entityType: "team",
                entityId: teamWithMembers.id.toString()
            });
    ...
    static async getTeamById(token, teamId) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/get_by_id/${teamId}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                credentials: "include"
    ...
    static async getTeamByCode(token, code) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/get_by_code/${code}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                credentials: "include"
    ...
    static async joinTeam(token, data) {
        try {
            // First get team by code
            const team = await this.getTeamByCode(token, data.code);
            // Then join team by id
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/join`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
            ...
            const joinedTeam = await this.getTeamById(token, team.id);
            const teamWithMembers = {
                ...joinedTeam,
                members: joinedTeam.members || []
            };
            // Log team join
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$logger$2f$api$2f$logger$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoggerService"].logAction(token, {
                action: "join_team",
                details: `Joined team: ${teamWithMembers.name}`,
                userId: teamWithMembers.members[teamWithMembers.members.length - 1]?.id || "unknown",
                entityType: "team",
                entityId: teamWithMembers.id.toString()
            });
            return teamWithMembers;
    ...
    static async getMyTeams(token) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/my-teams`, {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${token}`,
    ...
    static async getTeamMembers(token, teamId) {
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/${teamId}/members`, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                credentials: "include"
            ...
            return {
                ...await this.getTeamById(token, teamId),
...
function useTeams() {
    _s();
    const { token } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$providers$2f$auth$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthContext"])();
    ...
    const createTeam = async (data)=>{
        ...
        setIsLoading(true);
        try {
            const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].createTeam(token, data);
            setMyTeams((prev)=>[
                    ...prev,
                    team
                ]);
    ...
    const joinTeam = async (data)=>{
        ...
        setIsLoading(true);
        try {
            const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].joinTeam(token, data);
            setMyTeams((prev)=>[
                    ...prev,
                    team
                ]);
    ...
    const fetchMyTeams = async ()=>{
        ...
        try {
            ...
            const teams = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getMyTeams(token);
            ...
            toast({
                title: "Ошибка",
                description: error instanceof Error ? error.message : "Не удалось загрузить команды",
                variant: "destructive"
            });
        } finally{
            setIsLoading(false);
    ...
    const getTeamById = async (teamId)=>{
        ...
        setIsLoading(true);
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getTeamById(token, teamId);
        } catch (error) {
            toast({
                title: "Ошибка",
                description: error instanceof Error ? error.message : "Не удалось загрузить команду",
                variant: "destructive"
            });
        } finally{
            setIsLoading(false);
    ...
    const getTeamByCode = async (code)=>{
        ...
        setIsLoading(true);
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getTeamByCode(token, code);
        } catch (error) {
            toast({
                title: "Ошибка",
                description: error instanceof Error ? error.message : "Не удалось найти команду",
                variant: "destructive"
            });
        } finally{
            setIsLoading(false);
    ...
    const getTeamMembers = async (teamId)=>{
        ...
        setIsLoading(true);
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"].getTeamMembers(token, teamId);
        } catch (error) {
            toast({
                title: "Ошибка",
                description: error instanceof Error ? error.message : "Не удалось загрузить участников команды",
                variant: "destructive"
            });
        } finally{
            setIsLoading(false);
...
_s(useTeams, "QGaGybf5xx5KWTb+/viZ3L+KtKI=", false, function() {
    return [
...
function TeamsPage() {
    _s();
    const { isLoading, myTeams, createTeam, joinTeam, fetchMyTeams } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$lib$2f$use$2d$teams$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeams"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
    ...
    const [newTeamData, setNewTeamData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        name: "",
        description: ""
    });
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogDescription"], {
                                                        children: "Создайте команду для совместной работы над проектом"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/teams/page.tsx",
                                                        lineNumber: 135,
                                                        columnNumber: 17
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$textarea$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Textarea"], {
                                                                        ...
                                                                        placeholder: "Опишите цель создания команды"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/src/app/dashboard/teams/page.tsx",
                                                                        lineNumber: 154,
                                                                        columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: team.members?.map((member)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TeamsPage, "AMOARy9EqloxxcCZyz1Qc+8tqTU=", false, function() {
    return [
...
//# sourceMappingURL=_5fddabc2._.js.map