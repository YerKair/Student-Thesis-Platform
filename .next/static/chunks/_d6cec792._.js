...
class TeamsService {
    ...
    async getTeamById(id, token) {
        console.log(`Fetching team ${id} with token:`, token);
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/get_by_id/${id}`, {
            headers: {
                Authorization: `Bearer ${token}`
            },
            credentials: "include"
    ...
    async getTeamByCode(code, token) {
        console.log(`Fetching team by code ${code} with token:`, token);
        ...
        if (!response.ok) {
            const errorData = await response.json().catch(()=>null);
            console.error("Error fetching team by code:", {
                status: response.status,
                statusText: response.statusText,
                error: errorData
            });
        ...
        const team = await response.json();
        console.log("Fetched team by code:", team);
        return team;
    }
    async joinTeam(teamId, token) {
        console.log(`Joining team ${teamId} with token:`, token);
    ...
    async getTeamMembers(teamId, token) {
        console.log(`Fetching members for team ${teamId} with token:`, token);
...
function useTeams() {
    ...
    // Memoize the teamsService instance
    const teamsService = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useTeams.useMemo[teamsService]": ()=>new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TeamsService"]()
    }["useTeams.useMemo[teamsService]"], []);
    const createTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[createTeam]": async (data)=>{
            ...
            setIsLoading(true);
            try {
                const team = await teamsService.createTeam(data, token);
                setMyTeams({
    ...
    const joinTeam = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[joinTeam]": async (teamId)=>{
            if (!token) {
                throw new Error("No authorization token available");
            }
            setIsLoading(true);
            try {
                await teamsService.joinTeam(teamId, token);
    ...
    const getTeamById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[getTeamById]": async (id)=>{
            if (!token) {
                throw new Error("No authorization token available");
            }
            setIsLoading(true);
            try {
                const team = await teamsService.getTeamById(id, token);
                return team;
            } finally{
                setIsLoading(false);
            }
    ...
    const getTeamByCode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[getTeamByCode]": async (code)=>{
            ...
            setIsLoading(true);
            try {
                const team = await teamsService.getTeamByCode(code, token);
                return team;
            } finally{
                setIsLoading(false);
            }
    ...
    const getTeamMembers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTeams.useCallback[getTeamMembers]": async (teamId)=>{
            ...
            setIsLoading(true);
            try {
                const members = await teamsService.getTeamMembers(teamId, token);
                return members;
            } finally{
                setIsLoading(false);
            }
...
_s(useTeams, "DVLbZg/L8JA20C6xyLhGZXgLzh4=", false, function() {
    return [
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            children: team.creator_id === 1 ? "Создатель" : "Участник"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/dashboard/teams/page.tsx",
                                            lineNumber: 252,
                                            columnNumber: 19
...
_s(TeamsPage, "q/cwPis3QRXhllJ1/o2R81Iaqms=", false, function() {
    return [
...
//# sourceMappingURL=_d6cec792._.js.map