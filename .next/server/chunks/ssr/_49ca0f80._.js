...
function useTeams() {
    ...
    const createTeam = async (data)=>{
        ...
        setIsLoading(true);
        try {
            const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamsService"].createTeam(token, data);
            setMyTeams((prev)=>[
                    ...prev,
                    team
                ]);
    ...
    const joinTeam = async (data)=>{
        ...
        setIsLoading(true);
        try {
            const team = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamsService"].joinTeam(token, data);
            setMyTeams((prev)=>[
                    ...prev,
                    team
                ]);
    ...
    const fetchMyTeams = async ()=>{
        ...
        setIsLoading(true);
        try {
            const teams = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamsService"].getMyTeams(token);
            setMyTeams(teams);
            return teams;
        } catch (error) {
            toast({
    ...
    const getTeamById = async (teamId)=>{
        ...
        setIsLoading(true);
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamsService"].getTeamById(token, teamId);
        } catch (error) {
            toast({
                title: "Ошибка",
    ...
    const getTeamByCode = async (code)=>{
        ...
        setIsLoading(true);
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamsService"].getTeamByCode(token, code);
        } catch (error) {
            toast({
                title: "Ошибка",
    ...
    const getTeamMembers = async (teamId)=>{
        ...
        setIsLoading(true);
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamsService"].getTeamMembers(token, teamId);
        } catch (error) {
            toast({
                title: "Ошибка",
...
//# sourceMappingURL=_49ca0f80._.js.map