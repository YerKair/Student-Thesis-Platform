...
function UsersPage() {
    ...
    const handleRoleChange = async (userId, newRole)=>{
        if (!token) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UsersService"].addRole(userId, newRole, token);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Роль пользователя успешно обновлена");
            await fetchUsers(); // Refresh the list
        } catch (error) {
            console.error("Failed to update user role:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Не удалось обновить роль пользователя");
        }
    };
...
//# sourceMappingURL=src_3a801007._.js.map