...
class TeamsService {
    ...
    static async assignSupervisor(teamId, token) {
        try {
            const response = await fetch(`${API_BASE_URL}/teams/${teamId}/assign-supervisor`, {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${token}`
                }
...
function useTeams() {
    ...
    const getTeamMembers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (teamId)=>{
        if (!token) return;
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$api$2f$teams$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamsService"].getTeamMembers(teamId, token);
        } catch (error) {
...
function TeamsPage() {
    ...
    const { isLoading, teams, createTeam, joinTeam, fetchTeams, getTeamMembers, deleteTeam } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$lib$2f$use$2d$teams$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTeams"])();
    ...
    const myTeams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
    ...
    const handleJoinTeam = async (e)=>{
        ...
        try {
            ...
            setJoinCode("");
            // Refresh teams list after joining
            await fetchTeams();
            toast({
                title: "Успешно",
...
//# sourceMappingURL=_0fb0f0b1._.js.map