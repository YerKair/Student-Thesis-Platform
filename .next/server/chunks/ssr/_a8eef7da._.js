...
"[project]/src/features/users/api/users-service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/users/api/users-service.ts [app-ssr] (ecmascript)");
...
function UsersPage() {
    ...
    const fetchUsers = async ()=>{
        if (!token) return;
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UsersService"].getUsers(token);
            setUsers(response);
        } catch (error) {
            console.error("Failed to fetch users:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Не удалось загрузить список пользователей");
        } finally{
            setLoading(false);
        }
    };
        ...
        try {
            ...
            if (currentRoles.includes(role)) {
                ...
                if (currentRoles.length === 1) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("У пользователя должна быть хотя бы одна роль");
                    return;
                }
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$users$2f$api$2f$users$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["UsersService"].updateRoles(userId, newRoles, token);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Роли пользователя успешно обновлены");
            await fetchUsers(); // Обновляем список
        } catch (error) {
            console.error("Failed to update user roles:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Не удалось обновить роли пользователя");
        }
    };
...
//# sourceMappingURL=_a8eef7da._.js.map