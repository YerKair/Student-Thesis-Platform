...
class TeamsService {
    ...
    static async getTeamByCode(code) {
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$constants$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/get_by_code?code=${code}`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
    ...
    static async joinTeam(data) {
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$constants$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/teams/join?code=${data.code}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`
...
;
function TeamsPage() {
    const { isLoading, teams, createTeam, joinTeam, fetchMyTeams, getTeamMembers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$teams$2f$lib$2f$use$2d$teams$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTeams"])();
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useToast"])();
...
//# sourceMappingURL=_1b584091._.js.map