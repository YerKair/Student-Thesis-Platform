...
"[project]/src/shared/lib/format.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/features/projects/components/FileList.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/lib/format.ts [app-ssr] (ecmascript)");
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatFileSize"])(file.filePath.length),
                                            " •",
                                            " ",
...
"[project]/src/features/projects/api/project-files.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class ProjectFilesService {
    static async uploadFile(projectId, data) {
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$constants$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/projects/${projectId}/files`, {
            method: "POST",
            headers: {
    ...
    static async getFileVersion(versionId) {
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$constants$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/projects/files/${versionId}`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
    ...
    static async downloadFile(versionId) {
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$constants$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/projects/files/${versionId}/download`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
...
"[project]/src/features/projects/lib/use-project-files.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$project$2d$files$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/projects/api/project-files.service.ts [app-ssr] (ecmascript)");
"use client";
;
;
const useProjectFiles = (projectId)=>{
    const [fileVersions, setFileVersions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadFileVersions = async ()=>{
        try {
            setIsLoading(true);
            setError(null);
            const versions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$project$2d$files$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProjectFilesService"].getFileVersions(projectId);
    ...
    const uploadFile = async (data)=>{
        try {
            setIsLoading(true);
            setError(null);
            const newVersion = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$project$2d$files$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProjectFilesService"].uploadFile(projectId, data);
    ...
    const downloadFile = async (versionId, fileName)=>{
        try {
            setIsLoading(true);
            setError(null);
            const blob = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$project$2d$files$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProjectFilesService"].downloadFile(versionId);
...
"[project]/src/features/projects/components/Stage.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$upload$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Upload$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/upload.js [app-ssr] (ecmascript) <export default as Upload>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$components$2f$FileList$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/projects/components/FileList.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$lib$2f$use$2d$project$2d$files$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/projects/lib/use-project-files.ts [app-ssr] (ecmascript)");
;
;
;
;
...
const Stage = ({ projectId, title, description, deadline, status, supervisorComment, defaultExpanded = false })=>{
    ...
    const { fileVersions, isLoading, uploadFile, downloadFile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$lib$2f$use$2d$project$2d$files$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProjectFiles"])(projectId);
        ...
        children: [
            ...
            isExpanded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    supervisorComment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/src/features/projects/api/team-projects.service.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class TeamProjectsService {
    static async createProject(teamId, data) {
        ...
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$constants$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/projects/teams/${teamId}`, {
            method: "POST",
            headers: {
...
"[project]/src/features/projects/components/CreateProject.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$team$2d$projects$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/projects/api/team-projects.service.ts [app-ssr] (ecmascript)");
...
function CreateProject({ teamId, onProjectCreated }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setIsLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$team$2d$projects$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamProjectsService"].createProject(teamId, {
                name: name.trim(),
...
const Progress = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(({ className, value, ...props }, ref)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$react$2d$progress$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Root"], {
        ref: ref,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("relative h-4 w-full overflow-hidden rounded-full bg-secondary", className),
        ...props,
...
"[project]/src/app/dashboard/thesis/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$components$2f$Stage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/projects/components/Stage.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$components$2f$CreateProject$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/projects/components/CreateProject.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$team$2d$projects$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/projects/api/team-projects.service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/shared/ui/use-toast.ts [app-ssr] (ecmascript)");
...
function ThesisPage() {
    ...
    const [stages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([
        {
            id: 1,
    ...
    const loadProject = async (teamId)=>{
        try {
            setIsLoading(true);
            const project = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$projects$2f$api$2f$team$2d$projects$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TeamProjectsService"].getTeamProject(teamId);
            setProject(project);
        } catch (error) {
            toast({
                title: "Ошибка",
...
//# sourceMappingURL=_04692b16._.js.map